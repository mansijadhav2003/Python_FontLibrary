...
class homeLabel(tk.Frame):
    def __init__(self,parent,main_frame,userData):
        ...
        self.c2w_left_frame = tk.Frame(self.c2w_background_frame, bg="#00072D",
        ...
        background="#BCD2E8", padding=10, font=("Poppins", 12))
    ...
    def c2w_show_font_tab(self):
        ...
        if self.font_library_opened:
            messagebox.showinfo("Already Opened", "Font Library is alreadyopened!")
        else:
    ...
    def switch_to_class2(self):
        from FontList.fontList import FontListApp
