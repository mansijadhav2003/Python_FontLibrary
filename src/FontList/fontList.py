...
class FontListApp(tk.Frame):
    def __init__(self, parent, main_frame,userData):
        ...
        font_list_text = tk.Text(self.c2w_background_frame, wrap=tk.WORD,
        height=20, width=40, bg="white", fg="black", font=("Helvetica", 12))
        ...
        switch_button = ttk.Button(self, text="Back",
        command=self.switch_to_class1, style="Rounded.TButton")
