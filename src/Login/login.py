...
class MainFrame():
    ...
    def logIn(self):
        ...
        self.login = tk.Button(self.lgn_button_label, text='LOGIN', font=("yugothic ui", 13, "bold"), width=25, bd=0,bg='#3047ff', cursor='hand2',activebackground='#3047ff', fg='white', command=self.switch_to_homeLabel)
    ...
    def switch_to_homeLabel(self):
        from Home.home import homeLabel
        username_value = self.username_entry.get()
        userpassword_value = self.password_entry.get()
        if(username_value == 'Mansi' and userpassword_value == '9552996608'):
            ...
            return
        elif(username_value != 'Sushmita'):
            messagebox.showinfo("Error", "Incorrect Username")
        elif(userpassword_value == '7744920605'):
